    ...
    <Container fluid className="footer text-white">
      <Row className="p-5">
        ...
        <Col xs={12} md={3} lg={3} className="mt-3">
          ...
          <ul className="list-unstyled">
            <li>Find a host</li>
            <li>Info for hosts</li>
            <li>Info for Volunteers</li>
            <li>Join as host</li>
        ...
        <Col xs={12} md={3} lg={3} className="mt-3">
          ...
          <ul className="list-unstyled">
            <li>Volunteam Blog</li>
            <li>Photo Gallery</li>
            <li>Our Mission</li>
            <li>Volunteam Ambassadors</li>
          </ul>
        </Col>
        <Col xs={12} md={3} lg={3} className="mt-3">
          <div className="fw-bold mb-3">Language</div>
          <div className="list-unstyled language-list">
            <span>
              <img
      ...
      <Row>
        <Col sm={12} md={8} lg={6}>
          ...
          <div className="m-4 social-media">
            <span>
              <RiFacebookCircleFill className="mx-4 fs-1" />
            </span>
            <span>
              <FaInstagram className="mx-4 fs-1" />
            </span>
            <span>
              <TfiTwitter className="mx-4 fs-1" />
            </span>
            <span>
              <TfiYoutube className="mx-4 fs-1" />
            </span>
          </div>
        </Col>
      </Row>
